            ...
            <div className="relative w-full flex flex-col gap-3 md:gap-4">
                ...
                {!isViewMode && (
                    <p className="text-[10px] text-white/30 text-center mt-4 max-w-xs mx-auto leading-tight">
                        By sealing this moment, you agree to our <a href="/terms" className="underline cursor-pointer hover:text-white/50">Terms</a> and accept the use of cookies to preserve your legacy across time.
                    </p>
                )}
