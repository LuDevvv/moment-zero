...
export function OnboardingFlow({ onComplete, lang, targetYear, onThemeSelect }: OnboardingFlowProps) {
    ...
    // Audio or ref for animations could go here
        ...
        return (
            ...
            >
                ...
                <div className="space-y-6 max-w-2xl mx-auto z-10 px-4">
                    ...
                    <p className="text-xl md:text-2xl font-serif italic text-white/50">
                ...
                >
                    <span className="text-sm uppercase tracking-[0.2em] font-medium">Enter</span>
        ...
        return (
            ...
            >
                <div className="space-y-4 text-center">
                    <h2 className="text-4xl md:text-5xl font-display font-bold">How does your future feel?</h2>
                    <p className="text-muted-foreground text-lg">Select an atmosphere to set the tone.</p>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
                    {[
                        {
                            id: 'dark-void', // Was 'default'
                            name: 'Void',
                            desc: 'Deep. Calm. Infinite.',
                        ...
                        },
                        {
                            id: 'aurora',
                            name: 'Aurora',
                            desc: 'Mystical. Serene. Flowing.',
                            grad: 'from-purple-900/40 to-indigo-900/40',
                            ring: 'ring-purple-500'
                        },
                        {
                            id: 'starfield', // Was 'neo'
                            name: 'Starfield',
                            desc: 'Cosmic. Electric. Bright.',
                        ...
                        <motion.button
                            ...
                            className={`
                                relative p-8 h-52 rounded-3xl border flex flex-col justify-end text-left overflow-hidden transition-all duration-300
        ...
        return (
            ...
            >
                <div className="space-y-4">
                    <h2 className="text-3xl md:text-4xl font-display font-medium text-white/80">Make it last.</h2>
                    <p className="text-muted-foreground text-lg">What is your single most important hope for {targetYear}?</p>
                </div>
                ...
                <div className="w-full relative group">
                    <input
                        ...
                        placeholder="I will..."
                        className="w-full bg-transparent border-none py-8 text-4xl md:text-7xl text-center focus:outline-none focus:ring-0 placeholder:text-white/5 font-display font-bold tracking-tight text-white transition-all"
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    {["Find my peace", "Build something new", "Love fearlessly"].map((suggestion) => (
                        <button
                            key={suggestion}
                ...
                <div className="h-24 flex items-center justify-center gap-6 mt-8">
                    ...
                    {intention.length > 2 && (
                        ...
                        >
                            ...
                            <span>{lang.continueButton || "Next: Sign It"}</span>
                        </motion.button>
                    )}
                </div>
            </motion.div>
    ...
    if (step === "username") {
        return (
            ...
            >
                <div className="space-y-4">
                    <h2 className="text-3xl md:text-4xl font-display font-medium text-white/80">{lang.usernameTitle || "Claim your Identity"}</h2>
                    <p className="text-muted-foreground text-lg">{lang.usernameDesc || "Your capsule needs a guardian."}</p>
                </div>
                ...
                <div className="relative group w-full max-w-md">
                    ...
                    <input
                        ...
                        maxLength={20}
                        className="w-full bg-white/5 border border-white/10 rounded-2xl py-6 pl-12 pr-6 text-2xl md:text-4xl text-left focus:outline-none focus:ring-1 focus:ring-white/30 placeholder:text-white/10 font-display font-bold tracking-tight text-white transition-all"
                ...
                <div className="h-24 flex items-center justify-center gap-6 mt-4">
                    ...
                    {username.length > 2 && (
                        ...
                        >
                            {lang.reviewCapsule || "Review Capsule"}
                        </motion.button>
                    )}
                </div>
            </motion.div>
        ...
        return (
            ...
            >
                <div className="text-center space-y-2 mb-8 z-10">
                    <h2 className="text-2xl font-display font-medium text-white/80">{lang.previewTitle || "Your Legacy Awaits"}</h2>
                    <p className="text-muted-foreground text-sm">{lang.previewDesc || "This moment will be locked until 2027."}</p>
                </div>
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-2xl aspect-[16/10] md:aspect-[2/1] bg-black/40 backdrop-blur-xl rounded-[2rem] border border-white/10 shadow-[0_0_50px_-10px_rgba(255,255,255,0.1)] flex flex-col items-center justify-center p-8 md:p-12 text-center group overflow-hidden mb-12"
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-6">
                        ...
                        <h3 className="text-3xl md:text-5xl font-display font-medium text-white leading-tight italic">
                            "{intention}"
                        </h3>
                        <div className="flex items-center gap-3 mt-4 text-xs md:text-sm font-mono tracking-[0.2em] text-white/40 uppercase">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-xl z-20">
                    ...
                    >
                        ...
                        <div>
                            <div className="font-bold text-white text-sm tracking-wide mb-0.5">{lang.sealPrivate || "Seal Privately"}</div>
                    ...
                    >
                        ...
                        <div>
                            <div className="font-bold text-black text-sm tracking-wide mb-0.5">{lang.sealPublic || "Seal & Share"}</div>
